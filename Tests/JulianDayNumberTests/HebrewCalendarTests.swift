...
//		#expect(HebrewCalendar.yearContaining(julianDayNumber: -364898823) == -999999)
	...
	@Test func dateValidation() {
		#expect(HebrewCalendar.isDateValid(year: 3, month: 6, day: 30))
		#expect(!HebrewCalendar.isDateValid(year: 4, month: 6, day: 30))
	}
	...
	@Test func monthCount() {
		#expect(HebrewCalendar.monthsInYear(1) == 12)
		#expect(HebrewCalendar.monthsInYear(2) == 12)
		#expect(HebrewCalendar.monthsInYear(3) == 13)
		#expect(HebrewCalendar.monthsInYear(4) == 12)
		#expect(HebrewCalendar.monthsInYear(5) == 12)
		#expect(HebrewCalendar.monthsInYear(6) == 13)
		#expect(HebrewCalendar.monthsInYear(7) == 12)
		#expect(HebrewCalendar.monthsInYear(8) == 13)
		#expect(HebrewCalendar.monthsInYear(9) == 12)
		#expect(HebrewCalendar.monthsInYear(10) == 12)
		#expect(HebrewCalendar.monthsInYear(11) == 13)
		#expect(HebrewCalendar.monthsInYear(12) == 12)
		#expect(HebrewCalendar.monthsInYear(13) == 12)
		#expect(HebrewCalendar.monthsInYear(14) == 13)
		#expect(HebrewCalendar.monthsInYear(15) == 12)
		#expect(HebrewCalendar.monthsInYear(16) == 12)
		#expect(HebrewCalendar.monthsInYear(17) == 13)
		#expect(HebrewCalendar.monthsInYear(18) == 12)
		#expect(HebrewCalendar.monthsInYear(19) == 13)

		#expect(HebrewCalendar.monthsInYear(0) == 13)
		#expect(HebrewCalendar.monthsInYear(-1) == 12)
		#expect(HebrewCalendar.monthsInYear(-2) == 13)
		#expect(HebrewCalendar.monthsInYear(-3) == 12)
		#expect(HebrewCalendar.monthsInYear(-4) == 12)
		#expect(HebrewCalendar.monthsInYear(-5) == 13)
		#expect(HebrewCalendar.monthsInYear(-6) == 12)
		#expect(HebrewCalendar.monthsInYear(-7) == 12)
		#expect(HebrewCalendar.monthsInYear(-8) == 13)
		#expect(HebrewCalendar.monthsInYear(-9) == 12)
		#expect(HebrewCalendar.monthsInYear(-10) == 12)
		#expect(HebrewCalendar.monthsInYear(-11) == 13)
		#expect(HebrewCalendar.monthsInYear(-12) == 12)
		#expect(HebrewCalendar.monthsInYear(-13) == 13)
		#expect(HebrewCalendar.monthsInYear(-14) == 12)
		#expect(HebrewCalendar.monthsInYear(-15) == 12)
		#expect(HebrewCalendar.monthsInYear(-16) == 13)
		#expect(HebrewCalendar.monthsInYear(-17) == 12)
		#expect(HebrewCalendar.monthsInYear(-18) == 12)
	}

	@Test func monthLength() {
		#expect(HebrewCalendar.daysInMonth(year: 3, month: 6) == 30)
