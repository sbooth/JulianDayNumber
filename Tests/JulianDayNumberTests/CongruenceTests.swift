...
final class CongruenceTests: XCTestCase {
	func testEpoch() {
		...
		XCTAssertEqual(HebrewCalendar.julianDayNumberFrom(year: 1, month: 1, day: 1), JulianCalendar.julianDayNumberFrom(year: -3760, month: 10, day: 7))
		...
		XCTAssertEqual(PersianCalendar.julianDayNumberFrom(year: 1, month: 1, day: 1), JulianCalendar.julianDayNumberFrom(year: 632, month: 6, day: 16))
