...
final class JewishCalendarTests: XCTestCase {
	func testFirstDayOfTishrei() {
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 1), 347998)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 2), 348353)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 3), 348708)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 4), 349091)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 5), 349445)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 6), 349800)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 7), 350185)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 8), 350539)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 9), 350922)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 10), 351277)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 11), 351631)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 12), 352014)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 13), 352369)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 14), 352723)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 15), 353108)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 16), 353461)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 17), 353815)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 18), 354200)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 19), 354555)

//		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 0), 347614)
//		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: -1), 347261)
//		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: -2), 346876)
//		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: -3), 346521)
//		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: -4), 346167)
//		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: -951), 276)
//		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: -952), -109)
//		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: -953), -462)

		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 999999), 365594080)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 99999), 36871940)
		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: 9999), 3999723)
//		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: -9999), -3304494)
//		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: -99999), -36176711)
//		XCTAssertEqual(JewishCalendar.firstDayOfTishrei(year: -999999), -364898823)
	}
