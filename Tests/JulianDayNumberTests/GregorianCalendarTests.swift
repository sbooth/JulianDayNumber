...
@Suite struct GregorianCalendarTests {
	@Test func epoch() throws {
		...
		#expect(try GregorianCalendar.dateFromJulianDayNumber(GregorianCalendar.epoch) == (1, 1, 1))
	}
	...
	@Test func leapYear() throws {
		...
		for y in 1583...2500 {
			...
			let d = try GregorianCalendar.dateFromJulianDayNumber(j)
			#expect(d.month == 2)
	...
	@Test func dayOfWeek() throws {
		...
		#expect(GregorianCalendar.dayOfWeek(try GregorianCalendar.julianDayNumberFrom(year: 1954, month: 6, day: 30)) == 4)
	...
	@Test func julianDayNumber() throws {
		...
		#expect(try GregorianCalendar.dateFromJulianDayNumber(-363521074) == (-999999, 1, 1))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(-34802824) == (-99999, 1, 1))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(-1930999) == (-9999, 1, 1))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(5373484) == (9999, 12, 31))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(38245309) == (99999, 12, 31))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(366963559) == (999999, 12, 31))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(38) == (-4712, 1, 1))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(-1) == (-4713, 11, 23))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(0) == (-4713, 11, 24))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(1) == (-4713, 11, 25))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(2299150) == (1582, 10, 4))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(2299161) == (1582, 10, 15))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(2451545) == (2000, 1, 1))
		#expect(try GregorianCalendar.dateFromJulianDayNumber(-105152) == (-5000, 1, 1))
	}

	@Test func limits() throws {
		#expect(try GregorianCalendar.julianDateFrom(year: -999999, month: 1, day: 1) == -363521074.5)
		#expect(try GregorianCalendar.julianDateFrom(year: -99999, month: 1, day: 1) == -34802824.5)
		#expect(try GregorianCalendar.julianDateFrom(year: -9999, month: 1, day: 1) == -1930999.5)
		#expect(try GregorianCalendar.julianDateFrom(year: 9999, month: 12, day: 31) == 5373483.5)
		#expect(try GregorianCalendar.julianDateFrom(year: 99999, month: 12, day: 31) == 38245308.5)
		#expect(try GregorianCalendar.julianDateFrom(year: 999999, month: 12, day: 31) == 366963558.5)

		#expect(try GregorianCalendar.dateAndTimeFromJulianDate(-363521074.5) == (-999999, 1, 1, 0, 0, 0))
		#expect(try GregorianCalendar.dateAndTimeFromJulianDate(-34802824.5) == (-99999, 1, 1, 0, 0, 0))
		#expect(try GregorianCalendar.dateAndTimeFromJulianDate(-1930999.5) == (-9999, 1, 1, 0, 0, 0))
		#expect(try GregorianCalendar.dateAndTimeFromJulianDate(5373483.5) == (9999, 12, 31, 0, 0, 0))
		#expect(try GregorianCalendar.dateAndTimeFromJulianDate(38245308.5) == (99999, 12, 31, 0, 0, 0))
		#expect(try GregorianCalendar.dateAndTimeFromJulianDate(366963558.5) == (999999, 12, 31, 0, 0, 0))
	}

	@Test func arithmeticLimits() throws {
		let minDate = try GregorianCalendar.dateFromJulianDayNumber(.min)
		let minJ = try GregorianCalendar.julianDayNumberFromDate(minDate)
		#expect(minJ == .min)

		let maxDate = try GregorianCalendar.dateFromJulianDayNumber(.max)
