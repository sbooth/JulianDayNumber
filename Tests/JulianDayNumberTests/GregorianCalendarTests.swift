...
final class GregorianCalendarTests: XCTestCase {
	...
	func testDayOfYear() {
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 1, day: 1), 1)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 1, day: 31), 31)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 2, day: 1), 32)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 2, day: 28), 59)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 3, day: 1), 60)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 3, day: 31), 90)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 4, day: 1), 91)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 4, day: 30), 120)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 5, day: 1), 121)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 5, day: 31), 151)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 6, day: 1), 152)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 6, day: 30), 181)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 7, day: 1), 182)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 7, day: 31), 212)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 8, day: 1), 213)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 8, day: 31), 243)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 9, day: 1), 244)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 9, day: 30), 273)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 10, day: 1), 274)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 10, day: 31), 304)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 11, day: 1), 305)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 11, day: 30), 334)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 12, day: 1), 335)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 1900, month: 12, day: 31), 365)

		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 1, day: 1), 1)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 1, day: 31), 31)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 2, day: 1), 32)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 2, day: 29), 60)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 3, day: 1), 61)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 3, day: 31), 91)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 4, day: 1), 92)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 4, day: 30), 121)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 5, day: 1), 122)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 5, day: 31), 152)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 6, day: 1), 153)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 6, day: 30), 182)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 7, day: 1), 183)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 7, day: 31), 213)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 8, day: 1), 214)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 8, day: 31), 244)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 9, day: 1), 245)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 9, day: 30), 274)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 10, day: 1), 275)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 10, day: 31), 305)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 11, day: 1), 306)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 11, day: 30), 335)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 12, day: 1), 336)
		XCTAssertEqual(GregorianCalendar.dayOfYear(year: 2000, month: 12, day: 31), 366)
	}
